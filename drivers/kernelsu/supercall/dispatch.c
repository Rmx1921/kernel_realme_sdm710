...
static int do_susfs(void __user *arg)
{
    ...
    case CMD_SUSFS_ADD_SUS_PATH:
        error = susfs_add_sus_path((struct st_susfs_sus_path __user *)cmd.arg);
        break;
#endif
#ifdef CONFIG_KSU_SUSFS_SUS_MOUNT
    case CMD_SUSFS_ADD_SUS_MOUNT:
        error = susfs_add_sus_mount((struct st_susfs_sus_mount __user *)cmd.arg);
        break;
#endif
#ifdef CONFIG_KSU_SUSFS_SUS_KSTAT
    case CMD_SUSFS_ADD_SUS_KSTAT:
    case CMD_SUSFS_ADD_SUS_KSTAT_STATICALLY:
        error = susfs_add_sus_kstat((struct st_susfs_sus_kstat __user *)cmd.arg);
        break;
    case CMD_SUSFS_UPDATE_SUS_KSTAT:
        error = susfs_update_sus_kstat((struct st_susfs_sus_kstat __user *)cmd.arg);
        break;
#endif
#ifdef CONFIG_KSU_SUSFS_SUS_MAPS
    case CMD_SUSFS_ADD_SUS_MAPS:
    case CMD_SUSFS_ADD_SUS_MAPS_STATICALLY:
        error = susfs_add_sus_maps((struct st_susfs_sus_maps __user *)cmd.arg);
        break;
    case CMD_SUSFS_UPDATE_SUS_MAPS:
        error = susfs_update_sus_maps((struct st_susfs_sus_maps __user *)cmd.arg);
        break;
#endif
#ifdef CONFIG_KSU_SUSFS_SUS_PROC_FD_LINK
    case CMD_SUSFS_ADD_SUS_PROC_FD_LINK:
        error = susfs_add_sus_proc_fd_link((struct st_susfs_sus_proc_fd_link __user *)cmd.arg);
        break;
#endif
#ifdef CONFIG_KSU_SUSFS_SUS_MEMFD
    case CMD_SUSFS_ADD_SUS_MEMFD:
        error = susfs_add_sus_memfd((struct st_susfs_sus_memfd __user *)cmd.arg);
        break;
#endif
#ifdef CONFIG_KSU_SUSFS_TRY_UMOUNT
    case CMD_SUSFS_ADD_TRY_UMOUNT:
        error = susfs_add_try_umount((struct st_susfs_try_umount __user *)cmd.arg);
        break;
#endif
#ifdef CONFIG_KSU_SUSFS_SPOOF_UNAME
    case CMD_SUSFS_SET_UNAME:
        error = susfs_set_uname((struct st_susfs_uname __user *)cmd.arg);
        break;
#endif
#ifdef CONFIG_KSU_SUSFS_ENABLE_LOG
    case CMD_SUSFS_ENABLE_LOG:
        susfs_set_log(cmd.arg);
        error = 0;
        break;
#endif
    default:
    ...
    if (copy_to_user((void __user *)cmd.error, &error, sizeof(error))) {
        return -EFAULT;
    }
